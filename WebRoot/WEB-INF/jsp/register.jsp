                        ...
                        <li class="section allow active" id="opc-login">
                            ...
                            <div id="checkout-step-login">
                                <div class="col2-set">
                                    <div class="col-2">
                                        <h3>注册</h3>
                                        <form method="post" action="/sale/user/register" id="login-form" />
                                            <fieldset>
                                                <ul class="form-list">
                                                    <li>
                                                    ...
                                                    <li>
                                                        <label class="required" for="login-password"><em>*</em>邮箱</label>
                                                        <div class="input-box">
                                ...
                                <div class="col2-set">
                                    ...
                                    <div class="col-2">
                                        <div class="buttons-set"> <a class="fl_right" href="#"></a>
                                            <button class="button brown_btn" onclick="register();" type="button">注册</button>
                                        </div>
                                         <div class="buttons-set"> <a class="fl_right" href="#"></a>
